...
connectiondb = mysql.connector.connect(host="localhost", user="root", password="", database="worktrides11", port=3306)
    ...
    try:
        while True:
            ...
            if active_window_name != new_window_name:
                ...
                sql = "INSERT INTO monitoring (employee_id, company_id , m_title, m_start_time, m_end_time,m_total_duration,m_log_ts) VALUES (%s,%s, %s, %s, %s,%s,%s)"
                val = (employee_id, company_id, al,  start_time, ct,total_duration,ct1)  # Updated val to include start_time and end_time
